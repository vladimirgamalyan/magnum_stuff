...
git clone git://github.com/mosra/toolchains
git clone --single-branch --branch base-android git://github.com/mosra/magnum-bootstrap.git
git clone git://github.com/vladimirgamalyam/magnum_stuff.git
